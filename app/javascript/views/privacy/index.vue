  ...
  <AppContainer>
    ...
    <v-row class="privacy-content">
      <v-col class="pa-0">
        ...
        <div class="privacy-content__item">
          <h2 class="text-x-large">第1条（個人情報）</h2>
          <p class="text-default">
            「個人情報」とは、個人情報保護法にいう「個人情報」を指すものとし、生存する個人に関する情報であって、当該情報に含まれる氏名、生年月日、住所、電話番号、連絡先その他の記述等により特定の個人を識別できる情報及び容貌、指紋、声紋にかかるデータ、及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。
          </p>
        </div>
        <div class="privacy-content__item">
          <h2 class="text-x-large">第2条（個人情報の収集方法）</h2>
          <p class="text-default">
            当社は、ユーザーが利用登録をする際に氏名、生年月日、住所、電話番号、メールアドレス、銀行口座番号、クレジットカード番号、運転免許証番号などの個人情報をお尋ねすることがあります。また、ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を、当社の提携先（情報提供元、広告主、広告配信先などを含みます。以下、｢提携先｣といいます。）などから収集することがあります。
          </p>
        </div>
        <div class="privacy-content__item">
          <h2 class="text-x-large">第3条（個人情報を収集・利用する目的）</h2>
          <p class="text-default">当社が個人情報を収集・利用する目的は、以下のとおりです。</p>
        ...
        <div class="privacy-content__item">
          <h2 class="text-x-large">第4条（個人情報の第三者提供）</h2>
          <ol class="text-default">
            <li>
        ...
        <div class="privacy-content__item">
          <h2 class="text-x-large">第5条（アクセス解析ツール）</h2>
          <ol class="text-default">
            <li>
        ...
        <div class="privacy-content__item">
          <h2 class="text-x-large">第6条（プライバシーポリシーの変更）</h2>
          <ol class="text-default">
            <li>
